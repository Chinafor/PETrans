...
if __name__ == '__main__':
    ...
    parser.add_argument('--run_name', type=str,
                        help="name for wandb run", required=False,default='1')
    ...
    parser.add_argument('--data_name', type=str, default='moses3',
    ...
    mconf = GPTConfig(train_dataset.vocab_size, train_dataset.max_len, 0,
