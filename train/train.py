...
if __name__ == '__main__':
	...
	#parser.add_argument('--props', nargs="+", default=[], required=False)
    #parser.add_argument('--num_props', type=int, default = 0, required=False)
    ...
    mconf = GPTConfig(train_dataset.vocab_size, 78, 0, n_layer=args.n_layer, n_head=args.n_head, n_embd=args.n_embd, scaffold=args.scaffold, scaffold_maxlen=scaffold_max_len,
